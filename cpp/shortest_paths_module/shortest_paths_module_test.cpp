       {{17, 2}, 35.790273413104174}, {{18, 2}, 38.830069447697404}, {{13, 2}, 36.920091616035066},
       {{13, 2}, 36.922191511042065}, {{14, 2}, 43.96983913453139}
...
TEST(ShortestPaths, BellmanFordSmallGraphWithCycle) {
  size_t NUM_VERTEX = 6;
  uint64_t SOURCE = 0;
  auto G = mg_generate::BuildWeightedGraph(NUM_VERTEX,
                                           {
                                               /* 0*/ {{0, 1}, 50.0},
                                               /* 1*/ {{0, 2}, 50.0},
                                               /* 2*/ {{0, 3}, 100.0},
...
TEST(ShortestPaths, IterativeBellmanFordSmallGraphWithNegativeCycle) {
  ...
  shortest_paths::Path<> expected_path{{0, 1, 3, 4, 5}, {0, 3, 6, 8}, {0.0, 50.0, 90.0, 60.0, 100.0}, 100.0};
...
TEST(ShortestPaths, JohnsonsSmallGraphWithNegativeEdge) {
  ...
  std::vector<double> expected_edge_weights = {50.0, 60.0, 100.0, 40.0, 30.0, 70.0, 30.0, 80.0, 40.0, 0.0};
...
TEST(ShortestPaths, JohnsonsSmallGraphWithNegativeCycle) {
  ...
  std::vector<double> expected_edge_weights = {50.0, 50.0, 100.0, 40.0, 40.0, 110.0, 0.0, 80.0, 10.0, -130.0};
  ...
  shortest_paths::Path<> expected_path_0_5 = {{0, 1, 3, 4, 5}, {0, 3, 6, 8}, {0.0, 50.0, 90.0, 90.0, 100.0}, 100.0};
...
TEST(ShortestPaths, SSP_EmptyGraph) {
  ...
  auto paths = pathfinder.search(*G, 0, 0, 0.0, capacities, factors, 0.001, shortest_paths::FlowConversion::None,
                                 check_abort_noop);
...
TEST(ShortestPaths, SSP_SmallGraphNoConv) {
  auto G = mg_generate::BuildWeightedGraph(3,
                                           {
                                               /*0*/ {{0, 1}, 2.0},
                                               /*1*/ {{0, 1}, 1.0},
                                               /*2*/ {{0, 1}, 3.0},
  ...
  auto paths = pathfinder.search(*G, 0, 2, 110.0, capacities, factors, EPSILON, shortest_paths::FlowConversion::None,
                                 check_abort_noop);
  ...
  // previous.
  paths = pathfinder.search(*G, 0, 2, 100000.0, capacities, factors, EPSILON, shortest_paths::FlowConversion::None,
                            check_abort_noop);
  ...
  paths = pathfinder.search(*G, 0, 2, 100.0, capacities, factors, EPSILON, shortest_paths::FlowConversion::None,
                            check_abort_noop);
  ...
  paths = pathfinder.search(*G, 0, 2, 50.0, capacities, factors, EPSILON, shortest_paths::FlowConversion::None,
                            check_abort_noop);
...
TEST(ShortestPaths, SSP_SmallGraphConv_TargetOverSource) {
  ...
  auto paths = pathfinder.search(*G, 0, 2, max_flow_in, capacities, factors, EPSILON, CONV_MODE, check_abort_noop);
  ...
  // Search with flow_in > max flow for graph, result should be identical to
  // previous.
  paths = pathfinder.search(*G, 0, 2, max_flow_in * 2, capacities, factors, EPSILON, CONV_MODE, check_abort_noop);
  ...
  paths = pathfinder.search(*G, 0, 2, 50.0, capacities, factors, EPSILON, CONV_MODE, check_abort_noop);
...
TEST(ShortestPaths, SSP_SmallGraphConv_SourceOverTarget) {
  ...
  paths = pathfinder.search(*G, 0, 2, 95.0, capacities, factors, EPSILON, CONV_MODE, check_abort_noop);
...
TEST(ShortestPaths, PolyEdge_Construct) {
  ...
  constexpr const double TOLERANCE = 1.0e-6;
  ...
  // f(x) = 1 + 2x + 3x^2
  Eigen::VectorXd quad_x{{0.0, 1.0, 2.0}};
  Eigen::VectorXd quad_y{{1.0, 6.0, 17.0}};
  PolyEdge edge_quadratic_3coord(2UL, quad_x, quad_y);
  ASSERT_EQ(edge_quadratic_3coord.coefficients().size(), 3);
  // coefficients should be (1.0, 2.0, 3.0)
  ASSERT_DOUBLE_NEAR(edge_quadratic_3coord.coefficients()(0), 1.0, TOLERANCE);
  ASSERT_DOUBLE_NEAR(edge_quadratic_3coord.coefficients()(1), 2.0, TOLERANCE);
  ASSERT_DOUBLE_NEAR(edge_quadratic_3coord.coefficients()(2), 3.0, TOLERANCE);

  // y = 1 + x
  Eigen::VectorXd x{{0.0, 1.0}};
  Eigen::VectorXd y{{1.0, 2.0}};
  PolyEdge edge_linear(3UL, x, y);
  ASSERT_EQ(edge_linear.id(), 3UL);
  ASSERT_EQ(edge_linear.coefficients().size(), 2);
  // coefficients should be (1.0, 1.0)
  ASSERT_DOUBLE_NEAR(edge_linear.coefficients()(0), 1.0, TOLERANCE);
  ASSERT_DOUBLE_NEAR(edge_linear.coefficients()(1), 1.0, TOLERANCE);

  std::vector<double> x_vec{0.0, 1.0};
  std::vector<double> y_vec{1.0, 2.0};
  PolyEdge edge_linear_std(4UL, x_vec, y_vec);
  ASSERT_EQ(edge_linear_std.id(), 4UL);
  ASSERT_EQ(edge_linear_std.coefficients().size(), 2);
  // coefficients should be (1.0, 1.0)
  ASSERT_DOUBLE_NEAR(edge_linear_std.coefficients()(0), 1.0, TOLERANCE);
  ASSERT_DOUBLE_NEAR(edge_linear_std.coefficients()(1), 1.0, TOLERANCE);
}

TEST(ShortestPaths, PolyEdge_2PointQuadratic) {
  using shortest_paths::PolyEdge;
  constexpr const double TOLERANCE = 1.0e-6;

  // y = 1 + x^2
  Eigen::VectorXd x{{0.0, 2.0}};
  Eigen::VectorXd y{{1.0, 5.0}};
  PolyEdge edge(0UL, x, y, true);
  ASSERT_EQ(edge.id(), 0UL);
  ASSERT_EQ(edge.coefficients().size(), 3);
  // coefficients should be (1.0, 0.0, 1.0)
  ASSERT_DOUBLE_NEAR(edge.coefficients()(0), 1.0, TOLERANCE);
  ASSERT_DOUBLE_NEAR(edge.coefficients()(1), 0.0, TOLERANCE);
  ASSERT_DOUBLE_NEAR(edge.coefficients()(2), 1.0, TOLERANCE);
}
...
TEST(ShortestPaths, OptimizeFlow_Simple) {
  ...
  // TODO: Actually figure out what it should output.
}
