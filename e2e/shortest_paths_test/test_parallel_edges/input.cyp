...
MERGE (a:Node {id: 0}) MERGE (b:Node {id: 2}) MERGE (a)-[r:RELATION {id: 9}]->(b) ON CREATE SET r.weight = 70.0;
MERGE (a:Node {id: 3}) MERGE (b:Node {id: 5}) MERGE (a)-[r:RELATION {id: 10}]->(b) ON CREATE SET r.weight = 90.0;